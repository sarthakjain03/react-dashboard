  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-full p-8 pt-9 m-8 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
            ...
            <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
              ...
              <div className='mt-10 flex flex-wrap justify-center gap-10'>
                <div className='border-r-1 border-color m-4 pr-10'>
                  <div>
                    <p>
                      <span className='text-3xl font-semibold'>$93,890</span>
                  ...
                  <div className='mt-8'>
                    <p>
                      <span className='text-3xl font-semibold'>$45,668</span>
                    </p>
