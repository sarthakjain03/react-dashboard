...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transparent w-full fixed nav-item top-0 right-0">
      <div className="float-right h-screen  duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8 overflow-y-scroll">
                ...
                <div>
                  ...
                  <div className='flex gap-4 mt-2 items-center'>
                    ...
                    <div className='flex items-center border-1 border-r-0 border-color rounded'>
                      ...
                      <p className='p-2 border-r-1 border-color dark:border-gray-600 text-black-600'>0</p>
